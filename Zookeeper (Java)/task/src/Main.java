...
public class Main {
    public static void main(String[] args) {
        ...
        while(flag){
            ...
            switch (s){
                case "0":
                    System.out.println(animals[0]); break;
                case "1":
                    System.out.println(animals[1]); break;
                case "2":
                    System.out.println(animals[2]); break;
                case "3":
                    System.out.println(animals[3]); break;
                case "4":
                    System.out.println(animals[4]); break;
                case "5":
                    System.out.println(animals[5]); break;
                case "exit":
                    flag=false; break;
                default:
